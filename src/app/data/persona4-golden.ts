...
const arcana2Combos = [
  ...
  { source: ['Magician', 'Jester'], result: 'Heirophant' },
  ...
  { source: ['Heirophant', 'Jester'], result: 'Magician' },
  { source: ['Heirophant', 'Aeon'], result: 'Moon' },
  ...
  { source: ['Moon', 'Aeon'], result: 'Heirophant' },
...
const arcana3Combos = [
  ...
  { source: ['Heirophant', 'Magician'], result: 'Jester' },
  ...
  { source: ['Moon', 'Heirophant'], result: 'Aeon' },
  ...
  { source: ['Jester', 'Heirophant'], result: 'Fortune' },
  ...
  { source: ['Aeon', 'Heirophant'], result: 'Sun' },
  ...
  { source: ['Aeon', 'Sun'], result: 'Heirophant' },
